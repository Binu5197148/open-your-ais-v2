...
tags:
  ...
  - "Creative Workflow"
  - "Claude 4"
heroImage: "https://images.unsplash.com/photo-1487054119077-25d803b1aec6?ixid=M3w5MzA3NTd8MHwxfHNlYXJjaHwxMXx8c2hhZG93JTIwbGlnaHQlMjBwb3J0cmFpdHxlbnwxfDB8fHwxNzc2NzI0MjY3fDA&ixlib=rb-4.1.0&auto=format&fit=crop&w=1800&q=85&sat=-100&con=10"
...
<p>None of these are tasks. They are second-opinion checks. The ones I used to call a friend for at 11 pm and feel guilty about. Claude 4 is good enough at this kind of read that I do not feel like I am wasting the question, which is the bar for whether a tool gets used or quietly abandoned.</p><p>What I do with that read changes when the job is paid. On a commercial there is an approval chain, and the version I send is the version I have to defend in a room full of people who were not there when I made it. So on client work I stopped taking the first call the model makes, however good it sounds at midnight. I put my pass and its pass in the same document, mark which one is mine, and pick in the morning. Plenty of times I pick its version. What I cannot afford is to walk into the meeting with a cut I like and no memory of why it is that way.</p>
